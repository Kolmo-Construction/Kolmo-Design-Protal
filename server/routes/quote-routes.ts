...
const createQuoteSchema = z.object({
  ...
  subtotal: z.string().transform(val => !val || val === "" ? "0" : val),
  discountPercentage: z.string().transform(val => !val || val === "" ? "0" : val),
  discountAmount: z.string().transform(val => !val || val === "" ? "0" : val),
  taxPercentage: z.string().transform(val => !val || val === "" ? "0" : val),
  taxableAmount: z.string().transform(val => !val || val === "" ? "0" : val),
  taxAmount: z.string().transform(val => !val || val === "" ? "0" : val),
  totalAmount: z.string().transform(val => !val || val === "" ? "0" : val),
  ...
  downPaymentPercentage: z.string().optional().transform(val => !val || val === "" ? undefined : val),
  milestonePaymentPercentage: z.string().optional().transform(val => !val || val === "" ? undefined : val),
  finalPaymentPercentage: z.string().optional().transform(val => !val || val === "" ? undefined : val),
  milestoneDescription: z.string().optional(),
  acceptsCreditCards: z.boolean().default(false),
  creditCardProcessingFee: z.string().optional().transform(val => !val || val === "" ? undefined : val),
